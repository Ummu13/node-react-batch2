...
var phonesColors = phones.filter(function(item){
...
Sort(phonesColors, phonesColors.length);

for (var i = 0; i < phonesColors.length; i++) {
  console.log((i + 1) + ". " + phonesColors[i].name);
}
